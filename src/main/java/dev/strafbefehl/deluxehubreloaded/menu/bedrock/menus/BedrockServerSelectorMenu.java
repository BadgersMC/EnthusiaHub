package dev.strafbefehl.deluxehubreloaded.menu.bedrock.menus;

import com.google.common.io.ByteArrayDataOutput;
import com.google.common.io.ByteStreams;
import dev.strafbefehl.deluxehubreloaded.DeluxeHubPlugin;
import dev.strafbefehl.deluxehubreloaded.menu.MenuNavigator;
import dev.strafbefehl.deluxehubreloaded.menu.bedrock.BaseBedrockMenu;
import dev.strafbefehl.deluxehubreloaded.menu.bedrock.BedrockFormUtils;
import dev.strafbefehl.deluxehubreloaded.menu.bedrock.BedrockMenuNavigator;
...
public class BedrockServerSelectorMenu extends BaseBedrockMenu {
    ...
    private void executeAction(String actionStr) {
        ...
        switch (actionType) {
            ...
            default:
                plugin.getActionManager().executeActions(player, java.util.Collections.singletonList(actionStr));
                break;
        }
    }
