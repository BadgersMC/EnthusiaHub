package gg.badgersmc.enthusiahub;

import cl.bgmp.minecraft.util.commands.exceptions.*;
import gg.badgersmc.enthusiahub.action.ActionManager;
import gg.badgersmc.enthusiahub.module.modules.world.BuildMode;
import gg.badgersmc.enthusiahub.command.CommandManager;
import gg.badgersmc.enthusiahub.config.ConfigManager;
import gg.badgersmc.enthusiahub.config.ConfigType;
import gg.badgersmc.enthusiahub.config.Messages;
import gg.badgersmc.enthusiahub.config.Version;
import gg.badgersmc.enthusiahub.cooldown.CooldownManager;
import gg.badgersmc.enthusiahub.hook.HooksManager;
import gg.badgersmc.enthusiahub.inventory.InventoryManager;
import gg.badgersmc.enthusiahub.menu.bedrock.FloodgatePlatformDetection;
import gg.badgersmc.enthusiahub.menu.bedrock.FormStateManager;
import gg.badgersmc.enthusiahub.module.ModuleManager;
import gg.badgersmc.enthusiahub.module.ModuleType;
import gg.badgersmc.enthusiahub.module.modules.hologram.HologramManager;
import gg.badgersmc.enthusiahub.utility.NamespacedKeys;
import gg.badgersmc.enthusiahub.utility.UpdateChecker;
...
public class EnthusiaHubPlugin extends JavaPlugin {

	private static final int BSTATS_ID = 23061;
	private static EnthusiaHubPlugin instance;

	public static EnthusiaHubPlugin getInstance() {
		return instance;
	}
