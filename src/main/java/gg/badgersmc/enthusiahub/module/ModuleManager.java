package gg.badgersmc.enthusiahub.module;

import gg.badgersmc.enthusiahub.EnthusiaHubPlugin;
import gg.badgersmc.enthusiahub.command.CustomCommandHandler;
import gg.badgersmc.enthusiahub.config.ConfigType;
import gg.badgersmc.enthusiahub.module.modules.chat.AntiSwear;
import gg.badgersmc.enthusiahub.module.modules.chat.AutoBroadcast;
import gg.badgersmc.enthusiahub.module.modules.chat.ChatCommandBlock;
import gg.badgersmc.enthusiahub.module.modules.chat.ChatLock;
...
import gg.badgersmc.enthusiahub.module.modules.player.*;
import gg.badgersmc.enthusiahub.module.modules.visual.scoreboard.ScoreboardManager;
import gg.badgersmc.enthusiahub.module.modules.visual.tablist.TablistManager;
import gg.badgersmc.enthusiahub.module.modules.world.*;
...
public class ModuleManager {
	...
	public void loadModules(EnthusiaHubPlugin plugin) {
		this.plugin = plugin;
		...
		if (!config.getBoolean("multiple_worlds")) {
			if (EnthusiaHubPlugin.IsCompatible()){
...
//		}
	...
	public void registerModule(Module module, String isEnabledPath) {
		EnthusiaHubPlugin plugin = module.getPlugin();
