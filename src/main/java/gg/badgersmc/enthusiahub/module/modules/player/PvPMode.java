package gg.badgersmc.enthusiahub.module.modules.player;
...
public class PvPMode extends Module {
    ...
    public PvPMode(EnthusiaHubPlugin plugin) {
	...
	public void onEntityAttack(EntityDamageByEntityEvent ev) {
		...
		if (attacker.hasPermission(gg.badgersmc.enthusiahub.Permissions.PVP_BYPASS.getPermission())
				|| target.hasPermission(gg.badgersmc.enthusiahub.Permissions.PVP_BYPASS.getPermission())) {
			return;
		}
