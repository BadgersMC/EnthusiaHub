package net.badgersmc.enthusiahub.command;
...
import net.badgersmc.enthusiahub.command.commands.*;
import net.badgersmc.enthusiahub.command.commands.gamemode.*;
...
public class CommandManager {
	...
	public CommandManager(EnthusiaHubPlugin plugin) {
		this.plugin = plugin;
