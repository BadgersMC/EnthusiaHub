package net.badgersmc.enthusiahub.inventory.inventories;

import net.badgersmc.enthusiahub.EnthusiaHubPlugin;
import net.badgersmc.enthusiahub.inventory.AbstractInventory;
import net.badgersmc.enthusiahub.inventory.InventoryBuilder;
import net.badgersmc.enthusiahub.inventory.InventoryItem;
...
public class CustomGUI extends AbstractInventory {
	...
	public CustomGUI(EnthusiaHubPlugin plugin, FileConfiguration config) {
		super(plugin);
		this.config = config;
	}
