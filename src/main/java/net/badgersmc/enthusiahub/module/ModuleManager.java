...
import net.badgersmc.enthusiahub.command.CustomCommandHandler;
import net.badgersmc.enthusiahub.config.ConfigType;
import net.badgersmc.enthusiahub.module.modules.chat.AntiSwear;
import net.badgersmc.enthusiahub.module.modules.chat.AutoBroadcast;
import net.badgersmc.enthusiahub.module.modules.chat.ChatCommandBlock;
...
import net.badgersmc.enthusiahub.module.modules.player.*;
import net.badgersmc.enthusiahub.module.modules.visual.scoreboard.ScoreboardManager;
import net.badgersmc.enthusiahub.module.modules.visual.tablist.TablistManager;
import net.badgersmc.enthusiahub.module.modules.world.*;
