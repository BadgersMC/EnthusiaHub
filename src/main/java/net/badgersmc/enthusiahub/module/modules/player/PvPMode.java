...
import net.badgersmc.enthusiahub.utility.ItemStackBuilder;
...
public class PvPMode extends Module {
	...
	public void onEntityAttack(EntityDamageByEntityEvent ev) {
		...
		if (attacker.hasPermission(net.badgersmc.enthusiahub.Permissions.PVP_BYPASS.getPermission())
				|| target.hasPermission(net.badgersmc.enthusiahub.Permissions.PVP_BYPASS.getPermission())) {
			return;
		}
