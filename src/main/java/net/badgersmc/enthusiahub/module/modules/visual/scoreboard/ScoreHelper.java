package net.badgersmc.enthusiahub.module.modules.visual.scoreboard;
...
import static net.badgersmc.enthusiahub.utility.color.patterns.HexUtils.colorize;
import static net.badgersmc.enthusiahub.utility.color.patterns.HexUtils.translateHexColorCodes;
