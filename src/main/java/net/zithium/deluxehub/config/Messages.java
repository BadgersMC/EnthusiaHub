...
public enum Messages {
    ...
    PVP_SWORD_COUNTDOWN_START_ENABLE("PVP_SWORD.COUNTDOWN_START_ENABLE"),
    PVP_SWORD_COUNTDOWN_START_DISABLE("PVP_SWORD.COUNTDOWN_START_DISABLE"),
    PVP_SWORD_PVP_ENABLED("PVP_SWORD.PVP_ENABLED"),
    PVP_SWORD_PVP_DISABLED("PVP_SWORD.PVP_DISABLED"),
    PVP_SWORD_ALREADY_COUNTING("PVP_SWORD.ALREADY_COUNTING"),
    PVP_SWORD_COUNTDOWN_CANCELLED("PVP_SWORD.COUNTDOWN_CANCELLED");
