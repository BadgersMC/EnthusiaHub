...
import net.zithium.deluxehub.module.modules.hotbar.PvPSwordModule;
...
public class ModuleManager {
    ...
    public void loadModules(DeluxeHubPlugin plugin) {
        ...
        registerModule(new PvPSwordModule(plugin), "pvp_sword.enabled");  // Must be before WorldProtect
